        ...
        Scenario("When I parse a well formated file") {
            Then("BatchFile should contains 3 items") {
                ...
                assertThat(batch.cases).containsExactly(
                        ...
                        Case("MORZINE", Format.MARKET, IFLG.LG, "FRPC03", 1159, 1234, 432, 8430, 8430, 3020180036184, 6, AdosseSat.ADOSSE, Environment.PROD, "RHONE ALPES", "CARREFOUR MARKET MORZINE", "141 B ROUTE DU PLAN", "Adresse 3", "74110", "MORZINE", "IM6-0432", "10.224.135.183", "HP", "LOWER", "IM6-0432", "10.224.135.183", "HP", "UPPER")
                )
